...
public class GestorVuelos {
 ...
 //Se muestra por pantalla la lista ordenada.
		//System.out.println("	|Identificador|	|   Companhia   || Precio ||Hora de salida||Hora de llegada|| Duracion |"); --------
...
or (Person person : list) {
        System.out.println(person.getName()+ "   "+ person.getAge());
    }
  
 Ordenar elementos de una colección, modificando el metodo sort de la clase Collections.
